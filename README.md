```
                        ___                     
 ___  __ _  __ _ ___   / _ \_ __ _____  ___   _ 
/ __|/ _` |/ _` / __| / /_)/ '__/ _ \ \/ / | | |
\__ \ (_| | (_| \__ \/ ___/| | | (_) >  <| |_| |
|___/\__,_|\__,_|___/\/    |_|  \___/_/\_\\__, |
                                          |___/ 
                  @wizardbeard                  
```
...
Make it easy to test SaaS solutions:
...
This project structure and portion of the `README` come from: [golang-standards/project-layout](https://github.com/golang-standards/project-layout)
